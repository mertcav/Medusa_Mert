...
- Sıradaki dokümanlar: dokümantasyon + 0.2.x vendor eval hattı tamam → **0.3.x PoC** (canlı ölçüm; ADR-009) ve **Faz 1 kod**; 0.2.6 karar kayıtlarındaki provizyonel seçim + DPA/alt-işleyen (17.2.2) PoC çıktısıyla bağlanır.
