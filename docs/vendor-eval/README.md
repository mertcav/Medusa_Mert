...
| `samples/*.json` | İllüstratif entegrasyon-modu gecikme profilleri (PoC'ta gerçek ölçümle değişir) | 0.2.1 |

> Sıradaki: `0.2.2` STT, `0.2.3` TTS, `0.2.4` LLM, `0.2.5` Vector DB eval → `0.2.6` karar raporu.
